...
function Content() {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-5 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-60 2xl:px-60 bg-gray-50 dark:bg-black">
                ...
                <div className="bg-gray-50 dark:bg-black rounded-xl sm:border border-gray-300 dark:border-gray-600 shadow-black/20 min-h-[50px] col-span-2">
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-6 mx-8 my-4 gap-x-1 gap-y-2 ">
                        ...
                        <div className="h-6 w-24 bg-[#3178C6] text-xs text-white font-medium text-center cursor-pointer pt-1">TypeScript</div>
                        ...
                        <div className="h-6 w-24 bg-[#008eae] text-xs text-[#F29111] font-medium text-center cursor-pointer pt-1">MySQL</div>
                        ...
                        <div className="h-6 w-24 bg-[#0085D0] text-xs text-white font-medium text-center cursor-pointer pt-1">VSCode</div>
                ...
                <div className="bg-gray-50 dark:bg-black rounded-xl sm:border border-gray-300 dark:border-gray-600 shadow-black/20 min-h-[50px] sm:min-h-[50px] col-span-2 row-span-2 pb-10">
                    <div className="flex justify-between items-center pr-5 py-">
